...
func init() {
	proto.RegisterType((*GenesisState)(nil), "emarket.emarket.GenesisState")
}

func init() { proto.RegisterFile("emarket/emarket/genesis.proto", fileDescriptor_31d9a5a8f6f934f6) }
