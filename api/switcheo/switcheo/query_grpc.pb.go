...
const (
	Query_Params_FullMethodName  = "/switcheo.switcheo.Query/Params"
	Query_Item_FullMethodName    = "/switcheo.switcheo.Query/Item"
	Query_ItemAll_FullMethodName = "/switcheo.switcheo.Query/ItemAll"
)
...
func (c *queryClient) Item(ctx context.Context, in *QueryGetItemRequest, opts ...grpc.CallOption) (*QueryGetItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Item_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ItemAll(ctx context.Context, in *QueryAllItemRequest, opts ...grpc.CallOption) (*QueryAllItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ItemAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Item(context.Context, *QueryGetItemRequest) (*QueryGetItemResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Item not implemented")
}
func (UnimplementedQueryServer) ItemAll(context.Context, *QueryAllItemRequest) (*QueryAllItemResponse, error) {
...
func _Query_Item_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_Item_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ItemAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ItemAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
