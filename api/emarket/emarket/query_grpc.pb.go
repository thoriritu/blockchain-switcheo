...
const (
	Query_Params_FullMethodName  = "/emarket.emarket.Query/Params"
	Query_Item_FullMethodName    = "/emarket.emarket.Query/Item"
	Query_ItemAll_FullMethodName = "/emarket.emarket.Query/ItemAll"
)
